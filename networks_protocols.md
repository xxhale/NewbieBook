Тут будут рассмотрены основные вопросы и ответы по сетям и протоколам

1Q) Что такое модель OSI и каковы её семь уровней? Опишите функции каждого уровня.

1A) Модель OSI состоит из семи уровней:
